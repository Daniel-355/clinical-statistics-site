# =============================================================================
# PILOT clinical figure: Cumulative Incidence of First Dermatologic Event
#
...
stem <- "02_cumulative_incidence_time_to_event"
...
plot(
  ...
  main = "Cumulative Incidence of First Dermatologic Event",
  cex.main = 1.0,
  cex.lab = 0.9,
  cex.axis = 0.8
)
...
write_figure_rtf(png_path, rtf_path, "Cumulative Incidence of First Dermatologic Event", "14.2.2")
