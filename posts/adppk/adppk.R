...
metacore <- spec_to_metacore(file.path(project_root, "metadata", "pk_spec.xlsx")) %>%
...
write_adam_excel(
  haven::read_xpt(file.path(dir, "adppk.xpt")),
  "ADPPK",
  file.path(project_root, "adam", "adppk", "files", "adppk.xlsx")
)
