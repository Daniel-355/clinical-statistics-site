...
adlbc$TRTPN <- factor(adlbc$TRTPN, levels = c(0, 54, 81))
...
adlbh$TRTPN <- factor(adlbh$TRTPN, levels = c(0, 54, 81))
...
# Write out the RTF
write_rtf(doc, file=glue('{output_lib}/t-14-6-01/files/14-6.01.rtf'))
